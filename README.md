...
> A super computer case kit suitable for Raspberry Pi 5.
...
| non-display series             | NVMe Slot Count | SSD Support |
|-------------|------------|--------------|
| `FNK0107A`  | 1 Slot     | No          |
| `FNK0107B`  | 2 Slots    | No          | 
| `FNK0107C`  | 4 Slots    | No          |
...
| with 4.3inch IPS display       | NVMe Slot Count | SSD Support |
|-------------|------------|--------------|
| `FNK0107P`  | 1 Slot     | No          |
| `FNK0107Q`  | 2 Slots    | No          | 
| `FNK0107R`  | 4 Slots    | No          |
