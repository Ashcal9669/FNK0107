...
- Defaults monitor `/dev/sda,/dev/sdb` every 30 seconds with the built-in curve.
- Other users can edit `/etc/freenove-hdd-fan.conf` to change drive list, polling interval, and PWM period.
